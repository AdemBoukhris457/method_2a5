...
if (empty($_SESSION['e'])) {
    ...
    $error = "";
    $ProduitC = new ReclamationC();
    $listeReclamations = $ProduitC->afficherreclamations();
    // create user
                            ...
                            <table border=1 align='center' class="content-table" id="example">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td><?PHP echo $user['id_reclamation']; ?></td>
                                            <td><?PHP echo $user['titre']; ?></td>
                                            <td><?PHP echo $user['citation']; ?></td>
                                            <td><?PHP echo $user['date']; ?></td>
                                            <td><?PHP echo $user['id_utilisateur']; ?></td>
                                            <td>
                                                <form method="POST" action="dashboard-supp-reclamation.php">
                                                    <input type="submit" name="supprimer" value="supprimer">
                                                    <input type="hidden" value=<?PHP echo $user['id_reclamation']; ?> name="id_reclamation">
                                                </form>
                                            </td>
                                            <td>
                                                <a href="dashboard-modreclamation.php?id_reclamation=<?PHP echo $user['id_reclamation']; ?>"> Modifier </a>
                                            </td>
                                        </tr>
                                    <?PHP
                                    }
