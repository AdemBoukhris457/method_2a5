...
if (empty($_SESSION['e'])) {
    ...
    if (
        ...
        if (
            ...
            $AlimentC->modifierbillet($user, $_GET['id_billet']);
                ...
                <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                    <div class="card">
                        ...
                        if (isset($_GET['id_billet'])) {
                            $user = $AlimentC->recupererbillet($_GET['id_billet']);
                        ...
                        ?>
                            <form action="" method="POST">
                                <table class="table">
                                    <tr>
                                        <td>
                                            <label for="id_billet">id billet:
                                            </label>
                                        </td>
                                        <td><input type="number" name="id_billet" id="id_billet" value="<?php echo $user['id_billet']; ?>"></td>
                                    <tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="cni" id="cni"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <label for="id_evenement">id evenement:
                                            </label>
                                        </td>
                                        <td>
                ...
                <div class="card">
                    <table>
                        ...
                        <tbody> <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="supprimerBillet.php">
                                            ...
                                            <input type="hidden" value="<?PHP echo $row['id_billet']; ?>" name="id_billet">


                                        </form>
                                    </td>
                                    <td>
                                        <a href="dashboard-modbillet.php?id_billet=<?PHP echo $row['id_billet']; ?>"> Modifier </a>
                            ...
                            ?>
                            <tr>
                                <td><a href="exportbillet.php">Export Billet</a></td>
                            </tr>
                        </tbody>
                    </table>
