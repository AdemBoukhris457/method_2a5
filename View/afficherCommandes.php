...
if (empty($_SESSION['e'])) {
    ...
    $listeBlog = $AlimentC->afficherCommandes($_SESSION['lista']);
}
?>
            ...
            <div class="row">
                <div class="col-md-12 text-center probootstrap-animate">
                    <div class="probootstrap-heading">
                        <h2 class="primary-heading">vos</h2>
                        <h3 class="secondary-heading">commandes</h3>
                    </div>
                </div>
            </div>
        </div>
    </section>
    <a href="ajouterCommande.php" class="probootstrap-custom-link link-sm"> ajouter </a>
                ...
                ?>
                    <div class="col-md-4 col-sm-4 probootstrap-animate">
                        <div class="property-card">
                                        ...
                                        <center>
                                            <section>
                                                <div style="display: inline-block;">
                                                    <a href="modifierCommande.php?id_commande=<?PHP echo $user['id_commande']; ?>"> Modifier </a>
                                                </div>
                                                <div style="display: inline-block;">
                            ...
                            <?PHP echo $user['id_commande']; ?>
                            <?PHP echo $user['materiel']; ?>
                            <?PHP echo $user['quantite']; ?>
                            <?PHP echo $user['date']; ?>
                            <?PHP echo $user['id_utilisateur']; ?>
                            <div class="property-description">

                                <p><?PHP echo $user['materiel']; ?></p>
                                <p><?PHP echo $user['quantite']; ?></p>
                            </div>
