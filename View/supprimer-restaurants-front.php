   ...
   $restaurant = new restaurantC() ;
    if($_POST["action"] =="View")
    {
      header('location:restaurant-view.php');
       ...
       header('Location:afficher-resto.php');
   }
   else{
                ...
                <form action="modifier-resto-front.php" method="POST">
                                    <table class="table">
                                        <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="specialite1" id="specialite1"autofocus><?php if(isset($error3)&&!empty($error3)){ ?> <div class="error"><?php echo $error3;} ?></div>
                                                </td>
                                                                </tr>
                                                                <tr>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="hidden" value=<?PHP echo $_POST['id_restaurant']; ?> name="id_restaurant">
                                                </td>
                                                                </tr>
                                                                    <tr>
                                                                        <td></td>
