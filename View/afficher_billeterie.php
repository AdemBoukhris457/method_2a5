 ...
 <?PHP
include "../Controleur/billeterieC.php";
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4"><i class="fab fa-fw fa-wpforms"></i> evenement</a>
...
<a href="exportbillet.php"class="btn btn-warning" >export data</a>
                        
<table id="my table" class="table table-bordered" width=100% collaspacing="0" >
		<table id="my table" class="table table-bordered" width=100% collaspacing="0" >
        </div>
        </div>
       </div>
  ...
  <tbody>   <?php
  	$listebilleterie=$billeterieC->afficherbilleterie(); 
										...
										<td><?php echo $row['id_billet']; ?></td>
                                            ...
                                            <td>
                                               <form method="POST" action="deletebillet.php">
												...
												<td>
												<form method="POST" action="modifybilleterie.php">
