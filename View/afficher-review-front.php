...
$ReviewC =new ReviewC;
$listeResto = $ReviewC->afficherReviews();
$num= $ReviewC->count_table();
$it=0;
if(isset($_POST["nom_resto"])){
if($_POST["action"] =="Go"){
    $listeResto = $ReviewC->recupererReview($_POST["nom_resto"]);
      ...
      <section >
                      ...
                      <table>
                        <?php foreach($listeResto as $resto){ ?>
                            <?php if($it % 3==0){  ?>
                              ...
                              <td>
                                  <div class="card">
                                        <img class="card-image" src="../images/resto2.jpg" width="300px" height="210px"></img>
                                        <div class="card-text">
                                        ...
                                        <form action="supprimer-reviews-front.php" method="POST">
                                            ...
                                            <input type="hidden" value=<?PHP echo $resto['id_review']; ?> name="id_review">
              ...
              <form action="#" method="POST">
                  <div class="button">
                      ...
                      <input type="number" name="nom_resto" id="nom_resto">
