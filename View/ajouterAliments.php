        ...
        <div class="form sign-in">
            <form onsubmit="return validate()" action="" method="POST" id="myForm">
                ...
                <label>
                    ...
                    <input type="number" name="nb_calories" id="nb_calories" maxlength="20" value="<?php echo $_SESSION['password']; ?>">
                </label>
                <label>
                    <span>poids</span>
                ...
                <label>
                    ...
                    <input type="text" name="description" id="description" value="<?php echo $_SESSION['l']; ?>">
