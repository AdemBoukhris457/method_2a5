...
if (empty($_SESSION['e'])) {
    ...
    $listeBlog = $AlimentC->afficherCommandesadmin();
    // create user
    $AlimentC = new CommandeC();
    if (
        isset($_POST["materiel"]) &&
        isset($_POST["quantite"]) &&
        isset($_POST["date"]) &&
        isset($_POST["id_utilisateur"])
    ) {
        if (
            !empty($_POST["materiel"]) &&
            ...
            $AlimentC->modifierCommande($user, $_GET['id_commande']);
            header('Location:dashboard-modcommande.php');
        } else
                        ...
                        <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                ...
                                if (isset($_GET['id_commande'])) {
                                    $user = $AlimentC->recupererUtilisateur($_GET['id_commande']);
                                    ...
                                    <form action="" method="POST">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" name="id_commande" id="id_commande" value="<?php echo $user['id_commande']; ?>">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <input type="text" name="materiel" id="materiel" maxlength="20" value="<?php echo $user['materiel']; ?>">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <input type="number" name="quantite" id="quantite" maxlength="20">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <table border=1 align='center' class="content-table" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                <td><?PHP echo $user['id_commande']; ?></td>
                                                <td><?PHP echo $user['materiel']; ?></td>
                                                <td><?PHP echo $user['quantite']; ?></td>
                                                <td><?PHP echo $user['date']; ?></td>
                                                <td><?PHP echo $user['id_utilisateur']; ?></td>
                                                <td>
                                                    <form method="POST" action="dashboard-supp-commande.php">
                                                        <input type="submit" name="supprimer" value="supprimer">
                                                        <input type="hidden" value=<?PHP echo $user['id_commande']; ?> name="id_commande">
                                                    </form>
                                                </td>
                                                <td>
                                                    <a href="dashboard-modcommande.php?id_commande=<?PHP echo $user['id_commande']; ?>"> Modifier </a>
                                                </td>
                                            </tr>
                                        <?PHP
                                        }
