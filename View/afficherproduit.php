...
if (empty($_SESSION['e'])) {
    ...
    if (isset($_POST['ASC'])) {
        $AlimentC = new ProduitC();
        $listeAliments = $AlimentC->affichertriutilisateur($_SESSION['lista']);
    ...
    if (isset($_POST['search'])) {
        ...
        $listeAliments = $AlimentC->afficherrechutilisateur($_SESSION['lista'], $valueToSearch);
    } else {
        $listeAliments = $AlimentC->afficherProduitsUtilisateur($_SESSION['lista']);
    }
    $pC = new ProduitC();
    ...
    $listeAliments = $pC->afficherpaginutilisateur($_SESSION['lista'], $start_from, $num_per_page);
    if (isset($_POST['search'])) {
        $valueToSearch = $_POST['valueToSearch'];
        $listeAliments = $AlimentC->afficherrechutilisateur($_SESSION['lista'], $valueToSearch);
    } else {
    ...
    if (isset($_POST['ASC'])) {
        $AlimentC = new ProduitC();
        $listeAliments = $AlimentC->afficherpagintriutilisateur($_SESSION['lista'], $star, $numa);
    }
}
?>
...
<body>
    ...
    <center>
        ...
        if ($page > 1) {
            echo "<a href='afficherproduit.php?page=" . ($page - 1) . "' class='btn btn-danger'>Previous</a>";
        }


        for ($i = 1; $i < $total_page + 3; $i++) {
            echo "<a href='afficherproduit.php?page=" . $i . "' class='btn btn-primary'>$i</a>";
        }

        if ($i > $page) {
            echo "<a href='afficherproduit.php?page=" . ($page + 1) . "' class='btn btn-danger'>Next</a>";
        }
        ?>
    </center>
    <br>
