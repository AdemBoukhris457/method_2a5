                                    ...
                                    <form action="" method="POST">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td><input type="text" name="id_produit" id="id_produit" value="<?php echo $user['id_produit']; ?>"></td>
                                            <tr>
                                            <tr>
                                                <td>
                                                    <label for="nom">Nom:
                                                ...
                                                <td><input type="text" name="nom" id="nom" maxlength="20"><?php if (isset($nameErr) && !empty($nameErr)) { ?> <span class="error"><?php echo $nameErr;
                                                                                                                                                                                } ?></span></td>
                                            <tr>
                                                <td>
                                                    <label for="nb_calories">nbre_calories:
                                                    </label>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <label for="description">descriptiona:
                                                    </label>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <label for="id_utilisateur">id utilisateur:
                                                    </label>
                                                </td>
                                                <td>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST" action="dashboard-supp-produit.php">
