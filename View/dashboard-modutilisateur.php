...
if (empty($_SESSION['e'])) {
    ...
    if (
        ...
        if (
            ...
            $utilC->modifierUtilisateur($user, $_GET['id_utilisateur']);
            ...
            <div class="dashboard-finance">
                <div class="container-fluid dashboard-content">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h3 class="card-header" id="ajout">Modification</h3>
                                <div id="error">
                                    <?php echo $error; ?>
                                </div>
                                <div id="error">
                                ...
                                if (isset($_GET['id_utilisateur'])) {
                                    $user = $utilisateurC->recupererUtilisateur($_GET['id_utilisateur']);
                                ...
                                ?>
                                    <form action="" method="POST">
                                        <table class="table">
                                            <tr>
                                                <td>
                                                    <label for="id_utilisateur">id:
                                                    </label>
                                                </td>
                                                <td><input type="number" name="id_utilisateur" id="id_utilisateur" value="<?php echo $user['id_utilisateur']; ?>"></td>
                                            <tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td><input type="text" name="nom_utilisateur" id="nom_utilisateur" maxlength="20"></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td><input type="text" name="prenom_utilisateur" id="prenom_utilisateur" maxlength="20"></td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <label for="numero_tel">numero tel:
                                                    </label>
                                                </td>
                                                <td>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="dashboard-modutilisateur.php?id_utilisateur=<?PHP echo $user['id_utilisateur']; ?>"> Modifier </a>
                                            </td>
                                        </tr>
                                    <?PHP
                                    }
