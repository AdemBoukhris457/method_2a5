...
if (empty($_SESSION['e'])) {
    ...
    $listeBlog = $AlimentC->afficherMateriels();
    // create user
    $AlimentC = new MaterielC();
    if (
        isset($_POST["nom"]) &&
        ...
        if (
            ...
            $AlimentC->modifierMateriel($user, $_GET['id_materiel']);
            header('Location:dashboard-modmateriel.php');
        } else
                        ...
                        <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                ...
                                if (isset($_GET['id_materiel'])) {
                                    $user = $AlimentC->recupererUtilisateur($_GET['id_materiel']);
                                    ...
                                    <form action="" method="POST">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" name="id_Materiel" id="id_Materiel" value="<?php echo $user['id_materiel']; ?>">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                            ...
                            <table border=1 align='center' class="content-table" id="example">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td><?PHP echo $user['id_materiel']; ?></td>
                                            ...
                                            <td>
                                                <form method="POST" action="dashboard-supp-materiel.php">
                                                    <input type="submit" name="supprimer" value="supprimer">
                                                    <input type="hidden" value=<?PHP echo $user['id_materiel']; ?> name="id_materiel">
                                                </form>
                                            </td>
                                            <td>
                                                <a href="dashboard-modmateriel.php?id_materiel=<?PHP echo $user['id_materiel']; ?>"> Modifier </a>
                                            </td>
                                        </tr>
                                    <?PHP
                                    }
