                            ...
                            <div class="card">
                                ...
                                <form action="" method="POST">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>
                                                <label for="ingrediants">ingrediants:
                                                </label>
                                            </td>
                                            <td><input type="text" name="ingredients" id="ingredients" maxlength="20"><?php if (isset($agreeErr) && !empty($agreeErr)) { ?> <span class="error"><?php echo $agreeErr;
                                                                                                                                                                                            } ?></span></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <label for="id_produit">id produit:
                                                </label>
                                            </td>
                                            <td>
