                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="dashboard-sales.html">recettes</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/general.html">Reviews</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <div class="card">
                                ...
                                <form action="" method="POST">
                                    <table border="1" align="center">
                                        ...
                                        <tr>
                                            <td>
                                                <label for="ingrediants">nbre_calories:
                                                </label>
                                            </td>
                                            <td><input type="text" name="ingredients" id="ingredients" maxlength="20"></td>
                                        </tr>

                                        <tr>
                                            <td>
                                                <label for="description">poids:
                                                </label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <label for="specialite">descriptiona:
                                                </label>
                                            </td>
                                            <td>
                                ...
                                <table border=1 align='center'>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="dashboard-produits.php?id_produit=<?PHP echo $user['id_produit']; ?>"> Modifier </a>
                                            </td>
                                        </tr>
                                    <?PHP
                                    }
