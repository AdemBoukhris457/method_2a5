...
$listeRecettes = $RecetteC->afficherRecettes();
?>
<?php
                                ...
                                <form action="" method="POST">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <textarea type="textarea" name="description" id="description" cols="30" rows="10" ></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                ...
                                <form action="modifier-recettes.php" method="POST">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="ingredients1" id="ingredients1"></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="file" name="image1" id="image1" maxlength="250">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
