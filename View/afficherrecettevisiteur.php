...
<body>
    ...
    <center>
        <form action="afficherrecettevisiteur.php" method="post">
    ...
    <center>
        ...
        if ($page > 1) {
            echo "<a href='affichernewrecette.php?page=" . ($page - 1) . "' class='btn btn-danger'>Previous</a>";
        }


        for ($i = 1; $i < $total_page + 3; $i++) {
            echo "<a href='affichernewrecette.php?page=" . $i . "' class='btn btn-primary'>$i</a>";
        }

        if ($i > $page) {
            echo "<a href='affichernewrecette.php?page=" . ($page + 1) . "' class='btn btn-danger'>Next</a>";
        }
        ?>
    </center>
