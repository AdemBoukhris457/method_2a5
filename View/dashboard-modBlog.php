...
if (empty($_SESSION['e'])) {
    ...
    // create user
    $ProduitC = new BlogC();
    $listeBlog = $ProduitC->afficherBlog();
    $AlimentC = new BlogC();
    if (
        isset($_POST["titre"]) &&
        ...
        if (
            ...
            $AlimentC->modifierBlog($user, $_GET['id_blog']);
            header('Location:dashboard-modBlog.php');
        } else
                        ...
                        <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                ...
                                if (isset($_GET['id_blog'])) {
                                    $user = $AlimentC->recupererUtilisateur($_GET['id_blog']);
                                    ...
                                    <form action="" method="POST">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="id_blog" id="id_blog" value="<?php echo $user['id_blog']; ?>">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
