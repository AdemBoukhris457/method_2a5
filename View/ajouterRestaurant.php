      ...
      <div class="row">
        <div class="col-md-5 text-center probootstrap-animate">
          <div class="probootstrap-heading dark">
            <h1 class="primary-heading">Ajouter un Restaurant</h1>
        ...
        <img src="../images/resto6.jpg" alt="" class="img-responsive">
        ...
        <div class="col-md-6 col-md-push-1 probootstrap-animate">
          <form action="#" method="POST" class="probootstrap-form" name="fs" id="form">
            ...
            <div class="form-group">
                ...
                <center><input type="submit" name="action" value="Ajouter" class="btn btn-primary btn-lg "></center>
            </div>
          </form>
        </div>
      </div>
