                ...
                <form action="#" method="POST">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td><input type="text" name="nom" id="nom" maxlength="20" placeholder="Entrer un nom majuscule"> <?php if(isset($error1)&&!empty($error1)){ ?> <div class="error"><?php echo $error1;} ?></div></td>
                                            <tr>
                                                <td>
