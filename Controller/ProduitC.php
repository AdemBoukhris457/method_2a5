<?php 
    ...
    function afficherrechutilisateur($id_utilisateur,$valueToSearch)
    {
        $sql = "SELECT * FROM produits WHERE id_utilisateur=$id_utilisateur and CONCAT(`nom`, `nb_calories`, `poids`, `description`) LIKE '%" . $valueToSearch . "%'";
        $db = config::getConnexion();
        try {
            $liste = $db->query($sql);
            return $liste;
    ...
    function affichertriutilisateur($id_utilisateur)
    {
        $sql = "SELECT * FROM produits where id_utilisateur=$id_utilisateur order by nom";
        $db = config::getConnexion();
        try {
            $liste = $db->query($sql);
            return $liste;
    ...
    function afficherpaginutilisateur($id_utilisateur,$start_from, $num_per_page)
    {
        $sql = "SELECT * FROM produits where id_utilisateur=$id_utilisateur limit $start_from,$num_per_page";
        $db = config::getConnexion();
        try {
            $liste = $db->query($sql);
            return $liste;
    ...
    function afficherpagintriutilisateur($id_utilisateur,$start_from, $num_per_page)
    {
        $sql = "SELECT * FROM produits where id_utilisateur=$id_utilisateur order by nom limit $start_from,$num_per_page";
        $db = config::getConnexion();
        try {
            $liste = $db->query($sql);
            return $liste;
